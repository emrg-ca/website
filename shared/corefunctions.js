...
function menu_en() {
	...
	document.write('            <a class="menubar" target="_top" href="' + translated_href + '">Français</a> | ');
...
function menu_fr() {
	...
	document.write('            <a class="menubar" target="_top" href="http://translate.google.com/translate?u=http%3A%2F%2Fwww.emrg.ca%2Fmeetings.htm&langpair=en%7Cfr&hl=en&ie=UTF-8&oe=UTF-8&prev=%2Flanguage_tools">R&eacute;unions</A> | ');
