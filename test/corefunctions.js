...
function menu_en() {
	...
	document.write('            <a class="menubar" href="http://www.emrg.ca/contactus.htm">Contact Us</a> | ');
	...
	document.write('            <a class="menubar" href="news.htm"> News & Events </a> | ');
	document.write('            <a class="menubar" href="http://www.emrg.ca/library.htm">Library</a> | ');
	document.write('            <a class="menubar" href="http://www.emrg.ca/search.htm">Search</a>');
	document.write('       	</div>');
}
